...
print(f1,f1der,0,1e-10,5e4)
print(f2,f2der,0,1e-10,5e4)
print(f3,f3der,0,1e-10,5e4)
print(f4,f4der,0,1e-10,5e4)
print(f5,f5der,0,1e-10,5e4)
print(f6,f6der,0,1e-10,5e4)
print(f7,f7der,1,1e-10,5e4)
print(f8,f8der,0,1e-10,5e4)
print(f9,f9der,0,1e-10,5e4)
print(f10,f10der,1,1e-10,5e4)